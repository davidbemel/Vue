  ...
  <div class="container login" v-if='registro'>
    ...
    <div id='form' class="row">
     ...
     <div class="form-group">
       ...
       <div class="cols-sm-10">
         <div class="input-group">
           ...
           <input type="text" class="form-control" name="email" id="email"  placeholder="Correo Electrónico" v-model='correo' />
         </div>
       </div>
     </div>
       ...
       <div class="cols-sm-10">
         <div class="input-group">
           ...
           <input type="password" class="form-control" name="password" id="password"  
                  placeholder="Ingrese la contraseña" v-model='clave' />
         </div>
       </div>
     </div>
       ...
       <div class="cols-sm-10">
         <div class="input-group">
           ...
           <input type="password" class="form-control" name="confirm" id="confirm"  
                  placeholder="Confirme la contraseña" v-model='confirmClave' />
         </div>
       </div>
     </div>
     ...
     <div class="form-group row">
       <div class="col-3" ></div>
       <div class="col-6 btn btn-primary btn-lg btn-block login-button" @click='manejoClick($event)'>Resgistrar usuario</div>
       <div class="col-3" ></div>
     </div>
		</div>
	 </div>
